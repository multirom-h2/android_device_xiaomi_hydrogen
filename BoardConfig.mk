...
VENDOR_PATH := device/xiaomi/hydrogen
...
BOARD_USERDATAIMAGE_PARTITION_SIZE := 0x637bfbe00 #hydrogen 32GB
#BOARD_USERDATAIMAGE_PARTITION_SIZE := 0xd7f7fbe00 # helium 64GB
...
TARGET_LIBINIT_DEFINES_FILE := $(VENDOR_PATH)/init/init_hydrogen
